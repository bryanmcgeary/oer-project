...
\hypersetup{
  ...
  linkcolor=purple,
  urlcolor=purple,
  pdftitle={Online Statistics Education}
}
\usepackage{booktabs}
...
% Title
\textbf{\fontsize{48}{54}\selectfont Online Statistics Education \\}
\textbf{\large \textit{Test Version}}
...
\begin{flushright}
      ...
      \textbf{Bryan McGeary}, \emph{Pennsylvania State University}\\
